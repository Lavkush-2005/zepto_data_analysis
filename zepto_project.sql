...
-- stocked v/s Out-of-stocked product
SELECT outOfStock, COUNT (sku_id)
FROM zepto
GROUP BY outOfStock;

--products name which repeats multiple time
SELECT name, COUNT (sku_id) AS "Stocked keeping Units"
FROM zepto
GROUP BY name
...
--Q5. Identify the top 5 categories offering the average discount percentage.
